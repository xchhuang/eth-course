...
% normalize points by inv(K)

% multiplied by inverse of camera calibrated matrix
nnx1s = K \ x1s;
nnx2s = K \  x2s;
...
% decompose E to get the correct P from four possible solutions 
